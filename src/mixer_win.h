...
void mixer_win_source_add(uint32_t, const char *, const char *,
                          gboolean, double);
void mixer_win_source_update(uint32_t, const char *, gboolean, double);
void mixer_win_source_remove(uint32_t);

void mixer_win_sink_add(uint32_t, const char *, const char *, gboolean, double);
